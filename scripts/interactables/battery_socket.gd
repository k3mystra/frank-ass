...
@onready var battery_collision: CollisionShape3D = get_node_or_null("BatteryCollision") if has_node("BatteryCollision") else get_node_or_null("CollisionShape3D2") as CollisionShape3D
